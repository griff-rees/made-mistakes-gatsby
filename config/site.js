module.exports = {
  ...
  // JSONLD / Manifest
  favicon: '/images/favicon_2.svg', // Used for manifest favicon generation
  shortName: 'Griff Rees', // shortname for manifest. MUST be shorter than 12 characters
  author: {
    // Author for schema.org JSONLD
    name: 'Griffith Rees',
    url: 'https://griffithrees.org',
  },
  themeColor: '#ffffff',
